...
const frameVariants = tv({
    slots: {
        ...
        sidebar: "data-[side=start]:[grid-area:sbs] data-[side=end]:[grid-area:sbe] flex flex-col justify-between items-center data-[side=start]:border-e data-[side=end]:border-s",
